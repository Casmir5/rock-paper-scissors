...
const gameReset = function () {
  ...
  playerValue.src = `/img/right/value(1).png`;
  computerValue.src = `/img/left/value(1).png`;
  init();
};
...
for (const [i, btn] of buttons.entries()) {
  btn.addEventListener('click', function (e) {
    ...
    if (isPlaying) {
      ...
      playerValue.src = `/img/right/value(${playerRand}).png`;
      computerValue.src = `/img/left/value(${computerRand}).png`;
